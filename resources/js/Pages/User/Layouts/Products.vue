                ...
                <div v-for="product in products" :key="product.id" class="group relative">
                    <div
                        ...
                        <img v-if="product.product_images.length > 0" :src="product.product_images[0].image"
                            :alt="product.title" class="size-full object-cover object-center lg:size-full" />
                        <img v-else src="/product_images/images.png"
                            alt="No image" class="size-full object-cover object-center lg:size-full" />
                    </div>
